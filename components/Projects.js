    ...
    const projects = [
        {
            id: 1,
            title: 'Levare',
            description: 'Levare is a new upcoming financial technology company that provides financial solutions to individuals. I developed the website and set up domain, Dns configurations and SSl.',
            stack: 'React, Nextjs, Animate.css, Sass, Netlify',
            image: '/images/levare.png',
            link: 'https://levare.com',
            alt: 'Levare - Financial Technology Company'
        }
    ]
        ...
        <div className="bg-gray text-white max-w-none w-full m-auto py-10">
            <div className="mobile-width max-w-sm sm:max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl m-auto">
                    ...
                    projects.map(project => (
                        <div key={project.id} className="my-10 md:py-10 lg:m-auto lg:max-w-4xl flex flex-col items-center odd:sm:flex-row even:sm:flex-row-reverse md:justify-between lg:justify-between">
                            ...
                            <div className="m-auto sm:text-right md:m-0 sm:w-2/4 sm:h-2/4 mt-10 ">
                                <Image priority className="object-contain" src='/images/levare.png' alt={project.alt}  width={400} height={400} />
                            </div>
                        </div>
                    ))
                } */}
                ...
                <div className={`${category === 'Professional' ? 'block' : 'hidden'} my-20 md:py-16 lg:m-auto lg:max-w-4xl flex flex-col items-center sm:flex-row md:justify-between lg:justify-between`}>
                    ...
                    <div className="m-auto sm:text-left md:m-0 sm:w-2/4 sm:h-2/4 mt-10">
                        <Image priority className="object-contain" src='/images/itscopeconsulting.png' alt='Itscopeconsulting'  width={400} height={400} />
                    </div>
                </div>
                {/* <h2 className="lg:max-w-4xl lg:m-auto text-sm">PERSONAL WORK</h2> */}
                <div className={`${category === 'Personal' ? 'block' : 'hidden'} md:py-10 lg:m-auto lg:max-w-4xl flex flex-col items-center sm:flex-row-reverse md:justify-between lg:justify-between`}>
                    <div className="my-5 sm:w-2/4 ">
                        <h2 className="text-3xl font-semibold lg:text-5xl">E-Commerce App</h2>
                        <p className="my-5">My store is an e-commerece web application leveraging the fakestore API on a graphql-server on the server side and apollo-client on the client side. It features displaying products by categories, displaying single products, adding and deleting to cart using Reactive variables.</p>
                    ...
                    <div className="m-auto sm:text-left md:m-0 sm:w-2/4 sm:h-2/4 mt-10">
                        <Image priority className="object-contain" src='/images/mystore.png' alt='mystore - Developer(Esther)'  width={400} height={400} />
                    </div>
                </div>
                ...
                <div className={`${category === 'Personal' ? 'block' : 'hidden'} my-20 md:py-10 lg:m-auto lg:max-w-4xl flex flex-col items-center sm:flex-row-reverse md:justify-between lg:justify-between`}>
                    <div className="my-5 sm:w-2/4 ">
                ...
                <div className={`${category === 'Assessments' ? 'block' : 'hidden'} my-20 md:py-10 lg:m-auto lg:max-w-4xl flex flex-col items-center sm:flex-row-reverse md:justify-between lg:justify-between`}>
                    ...
                    <div className="m-auto sm:text-left md:m-0 sm:w-2/4 sm:h-2/4 mt-10">
                        <Image priority className="object-contain" src='/images/risevest.png' alt='Risevest Clone - Ejidike Esther'  width={400} height={400} />
                    </div>
                </div>
            </div>
        </div>
